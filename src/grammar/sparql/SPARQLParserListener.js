...
export default class SPARQLParserListener extends antlr4.tree.ParseTreeListener {
	...
	enterSelectModifier(ctx) {
	}

	// Exit a parse tree produced by SPARQLParser#selectModifier.
	exitSelectModifier(ctx) {
	}


	// Enter a parse tree produced by SPARQLParser#selectSingleVariable.
	enterSelectSingleVariable(ctx) {
	}

	// Exit a parse tree produced by SPARQLParser#selectSingleVariable.
	exitSelectSingleVariable(ctx) {
	}


	// Enter a parse tree produced by SPARQLParser#selectExpressionAsVariable.
	enterSelectExpressionAsVariable(ctx) {
	}

	// Exit a parse tree produced by SPARQLParser#selectExpressionAsVariable.
	exitSelectExpressionAsVariable(ctx) {
	}
	...
	// Enter a parse tree produced by SPARQLParser#rhsAdditiveExpression.
	enterRhsAdditiveExpression(ctx) {
	}

	// Exit a parse tree produced by SPARQLParser#rhsAdditiveExpression.
	exitRhsAdditiveExpression(ctx) {
	}


	// Enter a parse tree produced by SPARQLParser#rhsAdditiveExpressionSub.
	enterRhsAdditiveExpressionSub(ctx) {
	}

	// Exit a parse tree produced by SPARQLParser#rhsAdditiveExpressionSub.
	exitRhsAdditiveExpressionSub(ctx) {
	}
